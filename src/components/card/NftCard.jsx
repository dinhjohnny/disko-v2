...
const NftCard = ({ title, author, price, image, bidders, extra }) => {
  ...
  return (
    <Card
      extra={`flex flex-col w-full md:w-[15vw] h-full !p-4 3xl:p-![18px] bg-white ${extra}`}
    >
      <div className="h-full w-full">
        <div className="relative w-full">
          <img
            src={image}
            className="mb-3 h-[full] w-full rounded-xl 3xl:h-[full]  md:h-[20vh] 3xl:w-full object-cover"
            alt=""
          />
          <button
          ...
          >
            <div className="flex z-[2] h-full w-full items-center justify-center rounded-full text-xl hover:bg-gray-50 dark:text-navy-900">
              {heart ? (
                <IoHeartOutline />
              ) : (
